...
class GradeOfVN(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    total_mark_exam = models.FloatField(default=-1, null=True)
    total_mark_course = models.FloatField(default=-1, null=True)
    total_marks = models.FloatField(default=-1, null=True)
    coefficient_1_1 = models.FloatField(default=-1, null=True)
    coefficient_1_2 = models.FloatField(default=-1, null=True)
    coefficient_v2_1_1 = models.FloatField(default=-1, null=True)
    coefficient_v2_1_2 = models.FloatField(default=-1, null=True)
    coefficient_2_1 = models.FloatField(default=-1, null=True)
    coefficient_2_2 = models.FloatField(default=-1, null=True)
    coefficient_v2_2_1 = models.FloatField(default=-1, null=True)
    coefficient_v2_2_2 = models.FloatField(default=-1, null=True)
    practical_1_1 = models.FloatField(verbose_name="Thực hành",default=-1, null=True)
    practical_v2_1_1 = models.FloatField(verbose_name="Thực hành",default=-1, null=True)
    end_mark_1_1 = models.FloatField(default=-1, null=True)
    end_mark_v2_1_1 = models.FloatField(default=-1, null=True)
    #exam = models.ForeignKey(Exam, on_delete=models.CASCADE)
    student = models.ForeignKey(Student, on_delete=models.CASCADE)
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE)
